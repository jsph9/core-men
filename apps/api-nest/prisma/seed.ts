...
async function main() {
  ...
  await prisma.quote.create({
    data: {
      ...
      designs: { create: [{ placement: DesignPlacement.FRONT, techniqueId: getId(dbTechs, 'name', 'DTF')!, baseGarmentUrl: 'https://amazon-s3-coremen-bucket.s3.us-east-1.amazonaws.com/catalogo-coremen/PoloBasicoCuelloRedondo_f.png', logoUrl: '/logo1.png', positionX: 45, positionY: 30, width: 10, height: 10, rotation: 0, canvasWidth: 500, canvasHeight: 500 }, { placement: DesignPlacement.BACK, techniqueId: getId(dbTechs, 'name', 'DTF')!, baseGarmentUrl: 'https://amazon-s3-coremen-bucket.s3.us-east-1.amazonaws.com/catalogo-coremen/PoloBasicoCuelloRedondo_b.png', logoUrl: '/logo2.png', positionX: 50, positionY: 50, width: 28, height: 28, rotation: 0, canvasWidth: 500, canvasHeight: 500 }]},
  ...
  await prisma.quote.create({
    data: {
      ...
      designs: { create: [{ placement: DesignPlacement.FRONT, techniqueId: getId(dbTechs, 'name', 'Bordado')!, baseGarmentUrl: 'https://amazon-s3-coremen-bucket.s3.us-east-1.amazonaws.com/catalogo-coremen/PoleraCuelloV_f.png', logoUrl: '/name.png', positionX: 30, positionY: 30, width: 8, height: 4, rotation: 0, canvasWidth: 500, canvasHeight: 500 }]},
  ...
  await prisma.quote.create({
    data: {
      ...
      designs: { create: [{ placement: DesignPlacement.FRONT, techniqueId: getId(dbTechs, 'name', 'Bordado')!, baseGarmentUrl: 'https://amazon-s3-coremen-bucket.s3.us-east-1.amazonaws.com/catalogo-coremen/1782015998161-631224673.png', logoUrl: '/logo.png', positionX: 45, positionY: 35, width: 8, height: 8, rotation: 0, canvasWidth: 500, canvasHeight: 500 }, { placement: DesignPlacement.LEFTSLEEVE, techniqueId: getId(dbTechs, 'name', 'Bordado')!, baseGarmentUrl: 'https://amazon-s3-coremen-bucket.s3.us-east-1.amazonaws.com/catalogo-coremen/1782015998164-848136159.png', logoUrl: '/l.png', positionX: 50, positionY: 50, width: 5, height: 5, rotation: 0, canvasWidth: 500, canvasHeight: 500 }, { placement: DesignPlacement.RIGHTSLEEVE, techniqueId: getId(dbTechs, 'name', 'Bordado')!, baseGarmentUrl: 'https://amazon-s3-coremen-bucket.s3.us-east-1.amazonaws.com/catalogo-coremen/1782015998163-362873642.png', logoUrl: '/r.png', positionX: 50, positionY: 50, width: 5, height: 5, rotation: 0, canvasWidth: 500, canvasHeight: 500 }]},
  ...
  await prisma.quote.create({
    data: {
      ...
      designs: { create: [{ placement: DesignPlacement.FRONT, techniqueId: getId(dbTechs, 'name', 'Bordado')!, baseGarmentUrl: 'https://amazon-s3-coremen-bucket.s3.us-east-1.amazonaws.com/catalogo-coremen/PoleraCuelloV_f.png', logoUrl: '/l1.png', positionX: 40, positionY: 40, width: 5, height: 5, rotation: 0, canvasWidth: 500, canvasHeight: 500 }, { placement: DesignPlacement.BACK, techniqueId: getId(dbTechs, 'name', 'DTF')!, baseGarmentUrl: 'https://amazon-s3-coremen-bucket.s3.us-east-1.amazonaws.com/catalogo-coremen/PoleraCuelloV_b.png', logoUrl: '/l2.png', positionX: 50, positionY: 50, width: 30, height: 30, rotation: 0, canvasWidth: 500, canvasHeight: 500 }]},
